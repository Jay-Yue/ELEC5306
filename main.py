...
parser.add_argument('--train_epoch', default=40, type=int, help='number of train epoches')  # 180
...
# decayrate is decresed to zero here
parser.add_argument('--decayrate', default=0, type=float, help='decay rate')
...
if __name__ == '__main__':
    ...
    #Scheduler is changed to [20 40 80] with gamma = 0.5
    scheduler = MultiStepLR(optimizer, milestones=[20, 40, 80], gamma=0.5)  # learning rates milestones=[30, 60, 90]
